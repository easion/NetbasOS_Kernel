...
void tcp_shutdown(void);          // Must be called before shutdown to clear connections
...
#define TCPH_HDRLEN_SET(phdr, len) (phdr)->_offset_flags = htons(((len) << 12) | TCPH_FLAGS(phdr))

...
#define TCP_WND                 (32 * TCP_MSS)    // TCP window size
#define TCP_MAXRTX              32               // Maximum number of retransmissions
#define TCP_SYNMAXRTX           6                // Maximum number of SYN retransmissions 
#define TCP_MSL_MSEC                 60000            // The maximum segment lifetime in milliseconds

#define TCP_FAST_TMR_INTERVAL  5

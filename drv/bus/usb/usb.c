/*
 *	Jicama OS USB bus manager
 *
 *	Ported from the Syllable kernel USB code:
...
#define USB_LOCK spin_lock( &g_hUSBLock )
#define USB_UNLOCK spin_unlock( &g_hUSBLock );
 ...
 * \author	Arno Klenke (arno_klenke@yahoo.de)
 *****************************************************************************/
void* usb_bus_get_hooks( void *arg)
{
	return( &sBus );
}

static struct bus_man usbbus =
{
	bus_name: "USB",
	bus_hooks:usb_bus_get_hooks,
};

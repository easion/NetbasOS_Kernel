...
typedef struct usb_hc {
	...
	uint8_t device_address_bitmask[128/8];
} usb_hc;
...
int get_usb_descriptor(usb_device *device, uint8_t type, uint8_t index, uint16_t lang, void *data, size_t len);

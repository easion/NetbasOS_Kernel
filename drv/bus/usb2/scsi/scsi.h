...
static inline int atomic_read(int *p)
{
	return *p;
}
...
static inline void atomic_set(int *p, int n)
{
	*p=n;
}

static inline void atomic_dec(int *p)
{
	*p--;
}
...
typedef u64_t uint64;
//typedef u8_t u_char;
typedef u32_t sem_id;
typedef u32_t atomic_t;
typedef u32_t cdrom_toc_s; //fixme

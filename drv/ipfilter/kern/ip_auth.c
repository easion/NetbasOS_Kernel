/*	$NetBSD: ip_auth.c,v 1.12 2008/05/20 07:08:07 darrenr Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: ip_auth.c,v 1.12 2008/05/20 07:08:07 darrenr Exp $");
#else
...
thread_wait_t     fr_authnext_linux;
#endif
...
#endif
#if defined(__netbas__) && defined(_KERNEL)
	thread_waitq_init(&fr_authnext_linux);
#endif
